...
public class SwiftLuckieverseFlutterPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "setFullScreenAdZoneIdForSaju":
      log("[setFullScreenAdZoneIdForSaju] 호출됨, isInitializeCalled=\(isInitializeCalled)")
      guard let args = call.arguments as? [String: Any], let zoneId = args["zoneId"] as? String else {
        log("[ERROR] setFullScreenAdZoneIdForSaju: Missing zoneId")
        result(FlutterError(code: "bad_args", message: "Missing zoneId", details: nil)); return
      }
      log("[setFullScreenAdZoneIdForSaju] zoneId: \(zoneId)")
      #if canImport(Luckieverse)
      LuckieverseSDK.shared.setFullScreenAdZoneIdForSaju(zoneId)
      log("[setFullScreenAdZoneIdForSaju] 완료")
      result(nil)
      #else
      result(FlutterError(code: "unavailable", message: "Luckieverse.xcframework not integrated", details: nil))
      #endif

    case "setFullScreenAdZoneIdForNotSaju":
      log("[setFullScreenAdZoneIdForNotSaju] 호출됨, isInitializeCalled=\(isInitializeCalled)")
      guard let args = call.arguments as? [String: Any], let zoneId = args["zoneId"] as? String else {
        log("[ERROR] setFullScreenAdZoneIdForNotSaju: Missing zoneId")
        result(FlutterError(code: "bad_args", message: "Missing zoneId", details: nil)); return
      }
      log("[setFullScreenAdZoneIdForNotSaju] zoneId: \(zoneId)")
      #if canImport(Luckieverse)
      LuckieverseSDK.shared.setFullScreenAdZoneIdForNotSaju(zoneId)
      log("[setFullScreenAdZoneIdForNotSaju] 완료")
      result(nil)
      #else
      result(FlutterError(code: "unavailable", message: "Luckieverse.xcframework not integrated", details: nil))
      #endif

    case "setFullScreenAdZoneIdForFortuneCookie":
      log("[setFullScreenAdZoneIdForFortuneCookie] 호출됨, isInitializeCalled=\(isInitializeCalled)")
      guard let args = call.arguments as? [String: Any], let zoneId = args["zoneId"] as? String else {
        log("[ERROR] setFullScreenAdZoneIdForFortuneCookie: Missing zoneId")
        result(FlutterError(code: "bad_args", message: "Missing zoneId", details: nil)); return
      }
      log("[setFullScreenAdZoneIdForFortuneCookie] zoneId: \(zoneId)")
      #if canImport(Luckieverse)
      LuckieverseSDK.shared.setFullScreenAdZoneIdForFortuneCookie(zoneId)
      log("[setFullScreenAdZoneIdForFortuneCookie] 완료")
      result(nil)
      #else
      result(FlutterError(code: "unavailable", message: "Luckieverse.xcframework not integrated", details: nil))
      #endif

    case "setBannerAdZoneIdForSaju":
      log("[setBannerAdZoneIdForSaju] 호출됨, isInitializeCalled=\(isInitializeCalled)")
      guard let args = call.arguments as? [String: Any], let zoneId = args["zoneId"] as? String else {
        log("[ERROR] setBannerAdZoneIdForSaju: Missing zoneId")
        result(FlutterError(code: "bad_args", message: "Missing zoneId", details: nil)); return
      }
      log("[setBannerAdZoneIdForSaju] zoneId: \(zoneId)")
      #if canImport(Luckieverse)
      LuckieverseSDK.shared.setBannerAdZoneIdForSaju(zoneId)
      log("[setBannerAdZoneIdForSaju] 완료")
      result(nil)
      #else
      result(FlutterError(code: "unavailable", message: "Luckieverse.xcframework not integrated", details: nil))
      #endif

    case "setBannerAdZoneIdForNotSaju":
      log("[setBannerAdZoneIdForNotSaju] 호출됨, isInitializeCalled=\(isInitializeCalled)")
      guard let args = call.arguments as? [String: Any], let zoneId = args["zoneId"] as? String else {
        log("[ERROR] setBannerAdZoneIdForNotSaju: Missing zoneId")
        result(FlutterError(code: "bad_args", message: "Missing zoneId", details: nil)); return
      }
      log("[setBannerAdZoneIdForNotSaju] zoneId: \(zoneId)")
      #if canImport(Luckieverse)
      LuckieverseSDK.shared.setBannerAdZoneIdForNotSaju(zoneId)
      log("[setBannerAdZoneIdForNotSaju] 완료")
      result(nil)
      #else
      result(FlutterError(code: "unavailable", message: "Luckieverse.xcframework not integrated", details: nil))
      #endif

    case "setBannerAdZoneIdForFortuneCookie":
      log("[setBannerAdZoneIdForFortuneCookie] 호출됨, isInitializeCalled=\(isInitializeCalled)")
      guard let args = call.arguments as? [String: Any], let zoneId = args["zoneId"] as? String else {
        log("[ERROR] setBannerAdZoneIdForFortuneCookie: Missing zoneId")
        result(FlutterError(code: "bad_args", message: "Missing zoneId", details: nil)); return
      }
      log("[setBannerAdZoneIdForFortuneCookie] zoneId: \(zoneId)")
      #if canImport(Luckieverse)
      LuckieverseSDK.shared.setBannerAdZoneIdForFortuneCookie(zoneId)
      log("[setBannerAdZoneIdForFortuneCookie] 완료")
      result(nil)
      #else
      result(FlutterError(code: "unavailable", message: "Luckieverse.xcframework not integrated", details: nil))
      #endif
